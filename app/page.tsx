...
export default function Portfolio() {
  ...
  return (
    <>
      ...
      >
        <nav
          className={`fixed top-0 w-full z-50 transition-all duration-300 ${darkMode
              ...
              <div className="hidden md:flex space-x-8">
                {navItems.map((item) => (
                  <button
                    ...
                    className={`transition-colors duration-200 hover:text-orange-500 ${activeSection === item.id
                        ? "text-orange-500"
                        : darkMode
                          ? "text-white"
                          : "text-gray-900"
                ...
                <div className="px-4 py-2 space-y-2">
                  {navItems.map((item) => (
                    <button
                      key={item.id}
                      onClick={() => scrollToSection(item.id)}
                      className={`block w-full text-left py-2 px-4 rounded transition-colors duration-200 hover:bg-orange-500/10 ${activeSection === item.id
                          ? "text-orange-500"
                          : darkMode
                            ? "text-white"
                            : "text-gray-900"
        ...
        <section id="about" className="py-20 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                <div
                  className={`w-full h-124 rounded-lg ${darkMode ? "bg-gray-800" : "bg-gray-200"
                  ...
                  >
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div>
                        ...
                        <ul
                          className={`space-y-1 ${darkMode ? "text-gray-300" : "text-gray-600"
                            }`}
                        >
        ...
        <footer
          className={`py-8 px-4 border-t ${darkMode ? "border-gray-800" : "border-gray-200"
            }`}
        >
